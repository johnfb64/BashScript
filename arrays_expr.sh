#!/bin/bash
#####################################################################
# SCRIPT PARA TRANSFERENCIA DE ARCHIVOS DE BATMAN HACIA carpeta    #
...
########## VARIABLES ##########################################
DATE=`date '+%d-%m-%Y,%H:%M'`
LOG="/home/carpeta/logs/Trae_archivos_sftp_.log"
HOST="   "
PWD="   "
FOLDERINSUMO="/home/carpeta/TOT_AVISO/PROC_FILE"
ARCHIVO="/home/carpeta/TOT_AVISO/PROC_FILE/*.TXT"
DESTINO="/DESADV/OUT"
#DESTINO="/"
MAYUS="HSE"
MINUS="hse"
...
BCK="/reportes/carpeta/files/bckedicen/avides"
NFILE="TEST_AVISO.TXT"
RUTA_REMOTO="/reportes/carpeta/avides/"
...
then
   ...
   ls -ltr | grep $MINUS | awk '{print "cat "$9">>/home/carpeta/TOT_AVISO/PROC_FILE/TEST_AVISO.TXT"}' |sh &&\
   ls -ltr | grep $MAYUS | awk '{print "cat "$9">>/home/carpeta/TOT_AVISO/PROC_FILE/TEST_AVISO.TXT"}' |sh
   if [ $? -eq 0 ]
   then
      #Elimina $FORMAT
